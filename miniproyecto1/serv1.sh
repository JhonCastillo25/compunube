...
lxc init ubuntu:18.04 haproxy --target serv1
lxc start haproxy
...
backend web-backend
   ...
   stats uri /haproxy?stats
     option allbackups
   server cont1  172.42.42.102:5080 check
   server cont2  172.42.42.103:5080 check
   server contbk1 172.42.42.102:6080 check backup
   server contbk2 172.42.42.103:6080 check backup 
